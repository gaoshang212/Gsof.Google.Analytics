...
namespace Gsof.Google.Analytics.Test
{
    ...
    public class UnitTest1
    {
        ...
        {
            var ga = new Analytics(tid, "A22DA03C-BDF7-11E2-B50E-BC563DC62100", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Electron/1.7.6 Safari/537.36", false);
